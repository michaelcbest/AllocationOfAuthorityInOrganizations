*Ice Or Ice Block  - ItemID921

use 		"${rawdata}/POPSData/NewItemID921.dta", clear
local 		ItemID = NewItemID
ren			GroupFinal Treatment


replace 	DeliveryDate = 19981 if DeliveryDate == 52853
drop 		if UnitPrice==.
count
global NObs = `r(N)'
...
drop 		if UnitPrice < .002
drop		if UnitPrice > .3

global 		Attributes = ""
global 		NumberOfAttributes = 0
...
replace Unit = "Block <=20Kg" if inlist(Unit,"Block of 10 kg","Block of 15 Kg","Block of 20 kg")
replace Unit = "Block > 20Kg" if inlist(Unit,"Block of 1000 KGs","Block of 25 kg")
replace Unit = "Block > 20Kg" if inlist(Unit,"Block of 260 kg","Block of 40 kg")
